...
const downloadFile = async (file) => {
  ...
  try {
    ...
    let filename = file.file_name || 'attachment';
    ...
    // Auto-trigger file download with the extracted file name
